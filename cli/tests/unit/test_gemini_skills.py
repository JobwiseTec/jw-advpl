...
class TestInstallGeminiSkills:
    def test_installs_all_three_layers_when_signals_present(
        ...
        """~/.gemini/ + .gemini/ projeto → home + project MD + 59 skills."""
        ...
        assert result.installed_skills_count == 59
    ...
    def test_installs_to_agents_skills_when_present(
        ...
        assert len(agents_files) == 59
        assert result.installed_skills_count == 59
        assert result.installed_agents_skills_count == 59
