...
class TestInstallGeminiSkills:
    def test_installs_all_three_layers_when_signals_present(
        ...
        """~/.gemini/ + .gemini/ projeto → home + project MD + 58 skills."""
        ...
        assert result.installed_skills_count == 58
    ...
    def test_installs_to_agents_skills_when_present(
        ...
        assert len(agents_files) == 58
        assert result.installed_skills_count == 58
        assert result.installed_agents_skills_count == 58
